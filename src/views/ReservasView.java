...
import modelodatos.ControlDatosEstadia;
...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblValorSimbolo.setBounds(159, 332, 17, 25);
...
//Activa el evento, después del usuario seleccionar las fechas se debe calcular el valor de la reserva
		...
		txtValor.setBounds(96, 328, 43, 33);
		...
		btnsiguiente.setBounds(238, 470, 122, 35);
		panel.add(btnsiguiente);
		btnsiguiente.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

		JLabel lblSiguiente = new JLabel("SIGUIENTE");
		lblSiguiente.setBackground(new Color(0, 153, 255));
		lblSiguiente.setHorizontalAlignment(SwingConstants.CENTER);
		lblSiguiente.setForeground(Color.WHITE);
		lblSiguiente.setFont(new Font("Roboto", Font.PLAIN, 18));
		lblSiguiente.setBounds(0, 470, 122, 35);
		...
		btnCalcular.setFont(new Font("Dialog", Font.PLAIN, 18));
		lblSiguiente.setHorizontalAlignment(SwingConstants.CENTER);
		lblSiguiente.setForeground(Color.WHITE);
		lblSiguiente.setFont(new Font("Roboto", Font.PLAIN, 18));
		...
		btnCalcular.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				Instant start = txtFechaE.getDate().toInstant();
				Instant end = txtFechaS.getDate().toInstant();

				Long duracionEstadia = ChronoUnit.DAYS.between(start, end);
				// Duration duration = Duration.between(start, end);
				// long duracion = duration.time;
				System.out.println(duracionEstadia);
				long valorDia = 2000;
				long estadiaLong = duracionEstadia * valorDia;
				int estadiaInt = (int) estadiaLong;
				System.out.println(estadiaInt);

				txtValor.setText(Integer.toString(estadiaInt));
		...
		btnCalcular.setBounds(68, 470, 122, 35);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {
					...
					newSQLConection cc1 = new newSQLConection();
					Connection conn1 = cc1.getConnection();
					Statement st;
					String valor;
					...
					String fpago = ((JTextField) txtFormaPago.getEditor().getEditorComponent()).getText();
					String fpago1 = "No Pago";
					String SQL;
					// if txtFormaPago.getText() = null{
					// fpago fpago = new fpago1();
					...
					try {
						...
						pst.setString(1, fechae);
						pst.setString(2, fechas);
						pst.setString(3, valor);
						pst.setObject(4, fpago);
						...
						ResultSet rs = st.executeQuery("SELECT MAX(id) FROM Hotel_alura.Reservas");
						while (rs.next()) {

							System.out.println(rs.getString(1));
							String cartel = rs.getString(1);
							System.out.println(cartel);
							JOptionPane.showMessageDialog(null,
									"Su numero de reserva es " + cartel + " por favor ingreselo");
			...
			private java.sql.Date convert(Date fechae) {
		...
		btnNewButton.setBounds(164, 516, 99, 25);
